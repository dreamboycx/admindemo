<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:66:"E:\www\admindemo\public/../application/index\view\admin\index.html";i:1548324311;s:56:"E:\www\admindemo\application\index\view\index\_meta.html";i:1548324299;s:58:"E:\www\admindemo\application\index\view\index\_footer.html";i:1545309420;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
		...
		<tbody>
			<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
				<tr class="text-c">
					...
					<td class="td-status">
						<?php if($vo['status'] == 1): ?><span class="label label-success radius">已启用</span><?php else: ?><span class="label label-error radius">已停用</span><?php endif; ?>
					</td>
					<td class="td-manage"><a style="text-decoration:none" onClick="admin_stop(this,'10001')" href="javascript:;" title="停用"><i class="Hui-iconfont">&#xe631;</i></a> <a title="编辑" href="javascript:;" onclick="admin_edit('管理员编辑','admin-add.html','1','800','500')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a> <a title="删除" href="javascript:;" onclick="admin_del(this,'1')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
				</tr>
			<?php endforeach; endif; else: echo "" ;endif; ?>
			<tr><td colspan="9"><?php echo $list->render(); ?></td></tr>
		</tbody>
	</table>
</div>
<!--_footer 作为公共模版分离出去-->
...
<!--请在下方写此页面业务相关的脚本-->
<script type="text/javascript" src="/admindemo/public/static/lib/My97DatePicker/4.8/WdatePicker.js"></script> 
<script type="text/javascript" src="/admindemo/public/static/lib/datatables/1.10.0/jquery.dataTables.min.js"></script> 
<script type="text/javascript" src="/admindemo/public/static/lib/laypage/1.2/laypage.js"></script>
