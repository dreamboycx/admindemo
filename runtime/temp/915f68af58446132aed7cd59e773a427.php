...
<aside class="Hui-aside">
	<div class="menu_dropdown bk_2">
		<dl id="menu-admin">
			...
			<dd>
				<ul>
					<li><a data-href="<?php echo url('admin/roleList'); ?>" data-title="角色管理" href="javascript:void(0)">角色管理</a></li>
...
<!--请在下方写此页面业务相关的脚本-->
<script type="text/javascript" src="/admindemo/public/static/lib/jquery.contextmenu/jquery.contextmenu.r2.js"></script>
